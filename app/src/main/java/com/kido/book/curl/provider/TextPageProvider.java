package com.kido.book.curl.provider;
...
import com.kido.book.curl.view.CurlPage;
import com.kido.book.curl.view.CurlRenderer;
...
public class TextPageProvider extends BasePageProvider {
    ...
    private List<String> backStrings;

    public TextPageProvider(int margin, int padding, int border, int borderColor, int background, List<CharSequence> strings, ArrayList<String> backStrings) {
    ...
    public CharSequence getItem(final int index, boolean isBack) {
        if (isBack) {
...
//        }
    ...
    public void setStrings(List<CharSequence> strings) {
        this.strings = strings;
    }
    ...
    public TextPageProvider(ArrayList<CharSequence> data) {
        this.strings = data;
    }
    ...
    public void drawBitmap(final Canvas c, Rect r, final int index, boolean isBack) {
        CharSequence data = getItem(index, isBack);
        if (data == null) {
            return ;
        }
